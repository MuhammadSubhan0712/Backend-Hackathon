This project is a RESTful API for managing ecommerce products. It includes functionalities for  creating, reading, updating, and deleting products, along with image uploads using Cloudinary.
