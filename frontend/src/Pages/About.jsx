...
import { FaMapMarkerAlt, FaPhone, FaEnvelope, FaClock, FaShoppingBag, FaUsers, FaAward, FaHeadset } from "react-icons/fa";
      ...
      <section className="py-16 px-4 max-w-6xl mx-auto">
        ...
        >
          ...
          <p className="text-gray-400 max-w-3xl mx-auto">
            Founded in 2023, XD Shop began as a passion project for tech enthusiasts and has grown into a premier 
            destination for cutting-edge electronics and accessories. We curate only the finest products to ensure 
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-16">
          {[
            { icon: <FaShoppingBag size={40} />, title: "10,000+ Products", desc: "Wide selection" },
            { icon: <FaUsers size={40} />, title: "500,000+ Customers", desc: "Happy clients worldwide" },
            { icon: <FaAward size={40} />, title: "Industry Awards", desc: "Recognized excellence" }
          ].map((item, index) => (
            <motion.div
              key={index}
        ...
        <motion.div 
          ...
          className="mb-16"
        >
          <h2 className="text-3xl font-bold mb-8 text-center text-yellow-400">Meet The Team</h2>
